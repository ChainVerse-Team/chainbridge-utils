...
func TestBcryptingIsCorrect(t *testing.T) {
	...
	expectedHash := []byte("hYqnZX0MJZySLPf63qkrd9W/IGtQ0tW")
	...
	if err == nil && !bytes.Equal(expectedHash, hash) {
		t.Errorf("Parsed hash %v should equal %v", hash, expectedHash)
	}
}
...
func TestTooLongPasswordsWork(t *testing.T) {
	...
	tooLongExpected := []byte("79wiFC10hZs8wm9Yh8cJ02RZjUWXQVW")
